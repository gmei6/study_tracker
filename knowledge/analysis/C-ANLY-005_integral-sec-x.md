...
- **Last review:** 2026-06-29 — fail (sign errors on d/dx[tan x] and d/dx[sec x]; reached answer only with repeated guidance; see M-031, M-032). *(Full history: review/QUEUE.md Results column.)*
